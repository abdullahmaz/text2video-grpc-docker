...
from . import text2video_pb2 as text2video__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in text2video_pb2_grpc.py depends on'
...
def add_VideoGeneratorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'text2video.VideoGenerator', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('text2video.VideoGenerator', rpc_method_handlers)
